...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  fetch('/marvel').then(resp => resp.json()).then((data) => {
    ...
    // link to "details"
    document.getElementById('details').innerHTML = '<img class="icon" src="https://cdn.glitch.com/6bbc355b-2452-4bc6-bd23-083a6f363155%2Fperson.svg?1552155733974"><a href="' + d.urls[0].url + '" target="_blank" >Details</a>'
